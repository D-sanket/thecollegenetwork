...
Route::group(['middleware' => 'CustomAuth'], function (){
    ...
    Route::post('timeline/post/delete', 'PostController@deletePost');
    Route::post('timeline/post/deletecomment', 'PostController@deleteComment');
    ...
    Route::post('timeline/post/like', 'PostController@like');
